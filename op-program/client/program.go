...
func RunProgram(logger log.Logger, preimageOracle io.ReadWriter, preimageHinter io.ReadWriter) error {
	...
	l1PreimageOracle := l1.NewCachingOracle(l1.NewPreimageOracle(pClient, hClient.Write))
	l2PreimageOracle := l2.NewCachingOracle(l2.NewPreimageOracle(pClient, hClient.Write))
